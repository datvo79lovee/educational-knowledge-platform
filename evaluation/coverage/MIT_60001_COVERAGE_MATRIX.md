...
- Batch 02 có 20 record `approved` đã qua human review Answer Points và đã được canonicalize; 10 draft còn lại chưa phải canonical evaluation.
...
| --- | ---: | ---: | ---: | ---: | --- |
| Computation / course orientation | 2 | 0 | 0 | 2 | approved: q-001, q-002 |
...
| Strings | 0 | 1 | 1 | 1 | approved: q-027; chưa canonical: q-020 |
...
| Exceptions | 0 | 2 | 1 | 2 | approved: q-017, q-040; chưa canonical: q-032 |
| OOP / classes / inheritance | 0 | 2 | 2 | 2 | approved: q-030, q-041; chưa canonical: q-025, q-036 |
...
| Out-of-scope controls | 2 | 0 | 3 | 2 | approved: q-012, q-013; chưa canonical: q-042, q-043, q-044 |

## Batch 02 chưa canonical

- `unresolved_no_primary`: q-015, q-020, q-025, q-032.
- Human Answer Points decision `Reject`: q-024, q-028, q-036.
- Out-of-scope chưa có quyết định canonical: q-042, q-043, q-044.

## Quy tắc cập nhật

Mỗi lần thêm, thay wording, chấp nhận hoặc loại một evaluation question, cập nhật hàng concept liên quan, số đếm và Question IDs trong matrix này cùng milestone đó. Chỉ chuyển một câu sang cột approved khi canonical JSONL có record `approved` với Answer Points và source evidence đã được human review.
