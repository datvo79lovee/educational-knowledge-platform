...
- `reports/01_data_audit/video_summary.csv`: thống kê video theo năm và nguồn
- `reports/01_data_audit/transcript_summary.csv`: chi tiết 290 transcript đã JOIN metadata
- `reports/01_data_audit/checkpoint_status_summary.csv`: trạng thái lịch sử và trạng thái mới nhất
- `reports/01_data_audit/video_transcript_summary.csv`: kết quả JOIN cơ bản đã tạo trước đó
